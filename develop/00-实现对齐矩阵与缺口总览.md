...
| `develop/04-基础设施与运维/04-02-部署、灾备与持续集成方案.md` | 已落地（仓库范围） | CI、发布审计、回滚/WAL 校验与 prodlike 编排入口已落地。 |
...
| `develop/07-部署与运维/07-02-运维操作手册.md` | 已落地（仓库范围） | 预检、重连、WAL、回滚、编排与证据校验 SOP 已可执行。 |
