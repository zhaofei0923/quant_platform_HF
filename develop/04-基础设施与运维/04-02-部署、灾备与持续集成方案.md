...
- 交付打包、验包与审计摘要：`scripts/build/package_nonhotpath_release.sh`、`scripts/build/verify_nonhotpath_release.py`、`scripts/build/release_audit_summary.py`、`scripts/build/verify_release_audit_summary.py`。
