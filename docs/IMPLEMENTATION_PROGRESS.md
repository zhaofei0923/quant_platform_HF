...
## Sprint C5 (2026-02-11 ~ 2026-02-24)
- Objective:
  - validate auto chain detection over real TCP RESP path in CI
  - make ops smoke fail fast when chain evidence is not complete
- Scope:
  - `scripts/ops/fake_redis_bridge_server.py`
  - `.github/workflows/ci.yml`
  - `python/tests/test_ops_auto_chain_smoke.py`
  - `develop/04-基础设施与运维/04-01-监控、日志与告警体系设计.md`
  - `develop/00-实现对齐矩阵与缺口总览.md`
  - `develop/00-未完成能力补齐路线图.md`
- Test Evidence:
  - [x] `.venv/bin/pytest -q python/tests/test_ops_auto_chain_smoke.py`
  - [x] `.venv/bin/pytest -q python/tests/test_run_reconnect_evidence_script.py python/tests/test_monitoring_observability.py`
  - [x] `.venv/bin/ruff check python scripts`
  - [x] `.venv/bin/black --check python scripts`
  - [x] `.venv/bin/mypy python/quant_hft`
  - [x] `./scripts/build/bootstrap.sh`
...
## Sprint D4 (2026-02-11 ~ 2026-02-24)
- Objective:
  - emit structured release audit JSON for machine-queryable governance evidence
  - persist audit JSON as workflow artifact and tagged release asset
- Scope:
  - `scripts/build/release_audit_summary.py`
  - `python/tests/test_release_audit_summary_script.py`
  - `.github/workflows/release-package.yml`
  ...
  - `develop/04-基础设施与运维/04-02-部署、灾备与持续集成方案.md`
- Test Evidence:
  - [x] `.venv/bin/pytest -q python/tests/test_release_audit_summary_script.py python/tests/test_verify_nonhotpath_release_script.py`
  - [x] `VERSION=v0.2.3-dev1 && bash scripts/build/package_nonhotpath_release.sh "$VERSION"`
  - [x] `python3 scripts/build/verify_nonhotpath_release.py --bundle dist/quant-hft-nonhotpath-v0.2.3-dev1.tar.gz --checksum dist/quant-hft-nonhotpath-v0.2.3-dev1.tar.gz.sha256 --expect-version v0.2.3-dev1`
  - [x] `python3 scripts/build/release_audit_summary.py --bundle dist/quant-hft-nonhotpath-v0.2.3-dev1.tar.gz --checksum dist/quant-hft-nonhotpath-v0.2.3-dev1.tar.gz.sha256 --output docs/results/release_audit_summary.md --json-output docs/results/release_audit_summary.json`
  - [x] `.venv/bin/ruff check python scripts`
  - [x] `.venv/bin/black --check python scripts`
  - [x] `.venv/bin/mypy python/quant_hft`
  - [x] `.venv/bin/pytest python/tests -q`
...
## Sprint D5 (2026-02-11 ~ 2026-02-24)
- Objective:
  - enforce release audit JSON as a hard gate in release workflow
  - ensure audit JSON fields remain non-empty and internally consistent
- Scope:
  - `scripts/build/verify_release_audit_summary.py`
  - `python/tests/test_verify_release_audit_summary_script.py`
  - `scripts/build/package_nonhotpath_release.sh`
  - `scripts/build/verify_nonhotpath_release.py`
  - `python/tests/test_verify_nonhotpath_release_script.py`
  - `.github/workflows/release-package.yml`
  ...
  - `develop/04-基础设施与运维/04-02-部署、灾备与持续集成方案.md`
- Test Evidence:
  - [x] `.venv/bin/pytest -q python/tests/test_verify_release_audit_summary_script.py python/tests/test_release_audit_summary_script.py python/tests/test_verify_nonhotpath_release_script.py`
  - [x] `VERSION=v0.2.4-dev1 && bash scripts/build/package_nonhotpath_release.sh "$VERSION"`
  - [x] `python3 scripts/build/verify_nonhotpath_release.py --bundle dist/quant-hft-nonhotpath-v0.2.4-dev1.tar.gz --checksum dist/quant-hft-nonhotpath-v0.2.4-dev1.tar.gz.sha256 --expect-version v0.2.4-dev1`
  - [x] `python3 scripts/build/release_audit_summary.py --bundle dist/quant-hft-nonhotpath-v0.2.4-dev1.tar.gz --checksum dist/quant-hft-nonhotpath-v0.2.4-dev1.tar.gz.sha256 --output docs/results/release_audit_summary.md --json-output docs/results/release_audit_summary.json`
  - [x] `python3 scripts/build/verify_release_audit_summary.py --summary-json docs/results/release_audit_summary.json --expect-version v0.2.4-dev1 --expect-git-commit <short-head>`
  - [x] `.venv/bin/ruff check python scripts`
  - [x] `.venv/bin/black --check python scripts`
  - [x] `.venv/bin/mypy python/quant_hft`
  - [x] `.venv/bin/pytest python/tests -q`
...
## Sprint D6 (2026-02-11 ~ 2026-02-24)
- Objective:
  - generate machine-indexable release audit JSONL from summary JSON
  - publish audit index as CI artifact and tagged release asset
- Scope:
  - `scripts/build/release_audit_index.py`
  - `python/tests/test_release_audit_index_script.py`
  - `scripts/build/package_nonhotpath_release.sh`
  - `scripts/build/verify_nonhotpath_release.py`
  - `python/tests/test_verify_nonhotpath_release_script.py`
  - `.github/workflows/release-package.yml`
  ...
  - `develop/04-基础设施与运维/04-02-部署、灾备与持续集成方案.md`
- Test Evidence:
  - [x] `.venv/bin/pytest -q python/tests/test_release_audit_index_script.py python/tests/test_verify_nonhotpath_release_script.py`
  - [x] `python3 scripts/build/release_audit_index.py --summary-json docs/results/release_audit_summary.json --output-jsonl docs/results/release_audit_index.jsonl`
  - [x] `.venv/bin/ruff check python scripts`
  - [x] `.venv/bin/black --check python scripts`
  - [x] `.venv/bin/mypy python/quant_hft`
  - [x] `.venv/bin/pytest python/tests -q`
...
## Sprint D8 (2026-02-11 ~ 2026-02-24)
- Objective:
  - enforce WAL recovery drill evidence as machine-verifiable contract
  - package WAL evidence template + verifier for deployment artifact parity
- Scope:
  ...
  - `develop/07-部署与运维/07-02-运维操作手册.md`
- Test Evidence:
  - [x] `.venv/bin/pytest -q python/tests/test_verify_wal_recovery_evidence_script.py python/tests/test_verify_nonhotpath_release_script.py`
