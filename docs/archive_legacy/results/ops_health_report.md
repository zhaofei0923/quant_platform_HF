...
| quant_hft_storage_redis_health | n/a | 1 | no | input=unknown |
| quant_hft_storage_timescale_health | n/a | 1 | no | input=unknown |
| quant_hft_storage_postgres_health | n/a | 1 | no | input=unknown |
