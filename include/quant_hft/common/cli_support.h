...
inline std::string GetArg(const ArgMap& args, const std::string& key,
...
inline ResolvedConfigPath ResolveConfigPathWithDefault(const ArgMap& args, const std::string& key,
