...
ALTER TABLE IF EXISTS market_snapshots ADD COLUMN IF NOT EXISTS average_price_norm_valid BOOLEAN NOT NULL DEFAULT FALSE;
...
ALTER TABLE IF EXISTS order_events ADD COLUMN IF NOT EXISTS strategy_id TEXT NOT NULL DEFAULT '';
