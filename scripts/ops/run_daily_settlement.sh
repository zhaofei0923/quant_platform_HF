...
CTP_CONFIG_PATH="${CTP_CONFIG_PATH:-configs/prod/ctp.yaml}"
SETTLEMENT_BIN="${SETTLEMENT_BIN:-build/daily_settlement}"
EVIDENCE_JSON="${EVIDENCE_JSON:-docs/results/daily_settlement_evidence.json}"
DIFF_JSON="${DIFF_JSON:-docs/results/settlement_diff.json}"
PYTHON_BIN="${PYTHON_BIN:-python3}"
DAILY_SETTLEMENT_ORCHESTRATOR="${DAILY_SETTLEMENT_ORCHESTRATOR:-scripts/ops/daily_settlement_orchestrator.py}"
PRECISION_VERIFY_SCRIPT="${PRECISION_VERIFY_SCRIPT:-scripts/ops/verify_daily_settlement_precision.py}"
SETTLEMENT_BENCHMARK_SCRIPT="${SETTLEMENT_BENCHMARK_SCRIPT:-scripts/perf/run_daily_settlement_benchmark.py}"
RUN_READINESS_GATES=0
PRECISION_DATASET_JSON="${PRECISION_DATASET_JSON:-}"
PRECISION_RESULT_JSON="${PRECISION_RESULT_JSON:-docs/results/daily_settlement_precision_report.json}"
PRECISION_MIN_DAYS="${PRECISION_MIN_DAYS:-10}"
PRECISION_TOLERANCE="${PRECISION_TOLERANCE:-0.01}"
BENCHMARK_RESULT_JSON="${BENCHMARK_RESULT_JSON:-docs/results/daily_settlement_benchmark.json}"
