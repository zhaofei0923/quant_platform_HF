...
TEST(OpsCli, VerifyContractSyncCliReportsSuccessOnRepositoryContracts) {
    ...
    const std::filesystem::path cpp_contract_path = QUANT_STRATEGIES_CPP_CONTRACT;
    const std::filesystem::path proto_contract_path = QUANT_STRATEGIES_PROTO_CONTRACT;
