...
strategy_release: kama_trend@1.1.1
product_id: hc
...
components:
  - component_id: kama
    ...
    void SetUp() override {
        ...
        manifest["strategy_releases"].push_back("kama_trend@1.1.1");
        manifest["files"]["share/quant_strategies/1.1.1/schemas/atomic_parameters.yaml"] =
    ...
    void AddInstance(const std::string& id, const std::string& account,
        ...
        node["strategy_release"] = "kama_trend@1.1.1";
