...
TEST(PythonCallbackDispatcherTest, NonCriticalTaskDropsWhenQueueFull) {
    PythonCallbackDispatcher dispatcher(1, 10);
    dispatcher.Start();
...
TEST(PythonCallbackDispatcherTest, CriticalTaskTimesOutWhenQueueFull) {
    PythonCallbackDispatcher dispatcher(1, 10);
    dispatcher.Start();
